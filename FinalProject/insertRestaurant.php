...
<div class="container justify-content-center" style="margin-bottom: 2%">
    <form data-toggle="validator" role="form" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"
          ...
          method="post" action="resturant_insert.php">
        <div class="container justify-content-center">
            <div class="row justify-content-center">
                <div class="col-sm-10 justify-content-center" style="top: 30%">
                    <h3 class='text-center' style="margin-top: 5%" >Add Restauarant</h3>
                </div>
            </div>
            ...
            <div class="row justify-content-center" style="margin-bottom: 5%">
                <div class="col-sm-5 justify-content-center" id="field">
                    <input type="file" name="image" placeholder="Restaurant Name" id="image"
                           size="25%"class="inline-fields" onchange="previewFile(this)"required>
                </div>
                <div class="col-sm-5" id="field">

                    <img id="previewImgi" src="Images/transparent.png" alt="Placeholder" style="height: 80px; width: 80px">
                    Image
                </div>
            </div>
            <div class="row justify-content-center" style="margin-bottom: 5%">
            ...
            <div class="row justify-content-center" style="margin-bottom: 5%">
                ...
                <div class="col-sm-5 text-center" id="field">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-10 justify-content-center" id="field">
                    ...
                    <textarea id="form10" class="md-textarea form-control" name="about" rows="3" placeholder="About"></textarea>
                </div>
                </div>
            </div>
