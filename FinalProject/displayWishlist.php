...
echo'<li style="border-top: 1px solid #E7E7E7;
    ...
    font-weight: 300;"> My Wishlist</li></P>';
...
echo '<th style="padding: 0.8rem;
    ...
    text-transform: uppercase;
    margin-bottom: 0;
    color: #9F1D22;"> Image</th>';
while($row=mysqli_fetch_assoc($result)){
    if($row>0){
        echo"<tr>";
        echo'<td class="w-25 justify-content-between" style="cursor: pointer; padding: 0.8rem; border-bottom: 1px solid #E7E7E7; -webkit-transition: 0.2s all ease-in; transition: 0.2s all ease-in; margin-bottom: 1rem">'.$row['name'].'</td>';
        echo '<td><img src="Images/'.$row['image'].'" style="width:100%; height:100px"></td>';
        echo'</tr>';
    }
